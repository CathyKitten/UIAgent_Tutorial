...
You are an Excel expert. You are given an original request along with the corresponding instructional document.
...
Here is the operation logs and screenshots:
  '''
                ...
                try:
                    ...
                    output_result_file = os.path.join(root, "document_judge_result.json")
